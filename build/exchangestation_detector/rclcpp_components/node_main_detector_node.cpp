...
#define NODE_MAIN_LOGGER_NAME "detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libexchangestation_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<exchangestation_detector_node>";
