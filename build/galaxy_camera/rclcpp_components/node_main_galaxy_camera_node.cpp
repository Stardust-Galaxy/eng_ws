...
#define NODE_MAIN_LOGGER_NAME "galaxy_camera_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgalaxy_camera.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<galaxy_camera::GalaxyCameraNode>";
