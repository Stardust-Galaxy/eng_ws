...
class RefereeSystemGraphic : public rclcpp::Node {
    public:

        RefereeSystemGraphic(boost::asio::io_service& ioService): 
        Node("RefereeSystemGraphic") 
        ...
        ~RefereeSystemGraphic() {
            ...
            RCLCPP_INFO(this->get_logger(), "RefereeSystemGraphic has been stopped.");
        }
...
int main(int argc, char * argv[])
{
    ...
    rclcpp::spin(std::make_shared<RefereeSystemGraphic>(ioservice_));
    rclcpp::shutdown();
    return 0;
}
